...
##make light function that takes as input a date and time.  year is entered as "2013-01-01"Longstd is the standard longitude for your time zone (e.g., Mountain is 105).  Note that this changes with daylight savings time.  Our data will be in UTC, I suggest that we use standard time for all time zones.  This function only makes light for one year, so we will need to change it, have at it.
...
#Call as
lightest(time=chron(15500.1), lat=41.33,  longobs=105.7, longstd= 105, year="2013-01-01")

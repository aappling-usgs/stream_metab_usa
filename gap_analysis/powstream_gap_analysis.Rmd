...
allData_pop <- read.csv("../AC_popd10.csv")
allData_land <- read.csv("../AC_NLCD11.csv") #watershed area + agriculture
allData_run <- read.csv("../RUNOFF_AC.csv")
allData_temp <- read.csv("../TMEAN_AC.csv")
allData_precip <- read.csv("../PPT30YR_AC.csv")

# load data for reach catchments for entire US
#cannot find pop density file for reach catchment on science base
allData_land_RE <- read.csv("../NLCD11.csv")
...
eflow_metab <- read.csv("../eflow_metab.csv")

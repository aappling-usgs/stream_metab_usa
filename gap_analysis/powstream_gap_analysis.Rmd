...
make_map <- function(state){
  ...
  m = leaflet() %>% 
    ...
    addCircleMarkers(lng = do.sites$dec_long_va, 
                     lat = do.sites$dec_lat_va, 
                     popup = do.sites$station_nm, color = '#ff0000') %>% 
    addCircleMarkers(lng = disch.sites$dec_long_va, 
                     lat = disch.sites$dec_lat_va, 
...
####New Hampshire
```{r, echo=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
make_map('New Hampshire')
```

####Puerto Rico
```{r, echo=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
make_map('Puerto Rico')
```

####North Carolina
```{r, echo=FALSE, warning=FALSE, message=FALSE, eval=TRUE}
make_map('North Carolina')
```

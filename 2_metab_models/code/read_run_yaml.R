...
# names.
read_run1_yaml <- function(yamlfile='../2_metab_models/in/metab_configs_config.yml') {
  yaml.load_file(yamlfile)[['run1']]
}
read_run2_yaml <- function(yamlfile='../2_metab_models/in/metab_configs_config.yml') {
  yaml.load_file(yamlfile)[['run2']]
}
read_run3_yaml <- function(yamlfile='../2_metab_models/in/metab_configs_config.yml') {
